...
class BaseApiConfig:
    class GetWarehousesList(ApiConfig):
        """
        获取全部仓库信息列表
        """
    ...
    class SwitchWarehouse(ApiConfig):
        """
        切换仓库
        """
...
class TransferApiConfig:
    ...
    class TransferDemandList(ApiConfig):
        """调拨需求列表查询"""
    ...
    class PdaPickingDetail(ApiConfig):
        """PDA-按需装托时，获取拣货单详情"""
    ...
    class PdaSubmitTrayInfo(ApiConfig):
        """PDA-按需装托"""
    ...
    class PdaMoveStorage(ApiConfig):
        """PDA-不成套移出"""
    ...
    class PdaFinishPicking(ApiConfig):
        """PDA-创建出库单"""
    ...
    class SearchBoxOutList(ApiConfig):
        """查询调拨出库-箱单"""
    ...
    class PdaReviewSubmit(ApiConfig):
        """PDA-调拨复核"""
    ...
    class PdaChangeOrder(ApiConfig):
        """PDA-调拨出库-改单"""
    ...
    class PdaHandoverBind(ApiConfig):
        """PDA-调拨发货-扫描箱单"""
    ...
    class PdaDeliveryConfirm(ApiConfig):
        """PDA-调拨发货-发货"""
    ...
    class SearchBoxInList(ApiConfig):
        """PC-查询调拨入库-箱单"""
    ...
    class PdaTransferInConfirm(ApiConfig):
        """PDA-调拨入库-确认收货"""
    ...
    class PdaTransferInReceiveAll(ApiConfig):
        """PDA-调拨入库-整箱上架"""
    ...
    class PdaTransferInBoxScan(ApiConfig):
        """PDA-调拨入库-逐渐上架查看箱单详情"""
    ...
    class PdaTransferInReceiveOne(ApiConfig):
        """PDA-调拨入库-逐渐上架"""
    ...
    class CjPlatformTransferoutPage(ApiConfig):
        """仓间调拨-调拨出库单分页查询"""
    ...
    class CjDeliverInner(ApiConfig):
        """仓间调拨-发货"""
...
class OtherEntryOrderApiConfig:
    ...
    class GetByWareSkuCode(ApiConfig):
        """
        获取sku相关信息
        """
    ...
    class OtherAddSkuInfoPage(ApiConfig):
        """其他入添加商品时，查询接口"""
    ...
    class OtherEntryOrder(ApiConfig):
        """
        其他入库单
        """
    ...
    class GetSkuInfoByEntryCode(ApiConfig):
        """获取其他入库单内sku信息"""
    ...
    class GetEntryOrderById(ApiConfig):
        """
        获取入库单信息
        """
